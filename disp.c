...
char reloj[8], fecha[8];  //vectores para imprmir GLCD
 ...
 /////////////////////////////////////////////// INTERRUPCIÓN DEL TIMER0 (CUENTA CADA SEGUNDO) /////////////////////////////////////////////////
...
////////////////// FUNCIÓN PARA EL SONIDO DEL BUZZER (El tiempo que suena depende del Macro: DELAY BUZZER) ////////////////// 
void buzz()
{       //Sonido de Buzzer
...
///////////////////////// FUNCIÓN DEL BOTÓN 2 (ESCOGER RUTA AUMENTAR LETRA) /////////////////////////////////
...
/////////////////////// FUNCIÓN DEL BOTÓN 3 (ESCOGER RUTA DECREMENTAR LETRA) /////////////////////////////////
void boton3(){     //Botón 3
...
//////////////////////// FUNCIÓN DEL BOTÓN 4 (INICIO/FIN DE RUTA) /////////////////////////////////
void boton4(){     //Botón 4
